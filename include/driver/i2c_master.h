...
int16_t i2c_master_readRegister16wait(uint8 address, uint8 regaddr, bool waitnack);
int16_t i2c_master_readRegister16(uint8 address, uint8 regaddr);
int8_t i2c_master_readRegister8(uint8 address, uint8 regaddr);
