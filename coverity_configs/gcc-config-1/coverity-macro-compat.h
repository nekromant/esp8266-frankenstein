...
#endif
#if !(defined(__XTENSA_CALL0_ABI__) || defined(__coverity_undefine___XTENSA_CALL0_ABI__))
...
#endif
#if !(defined(__XTENSA_EL__) || defined(__coverity_undefine___XTENSA_EL__))
...
#endif
#if !(defined(__XTENSA_SOFT_FLOAT__) || defined(__coverity_undefine___XTENSA_SOFT_FLOAT__))
...
#define __ELF__ 1
#endif
#if !(defined(__xtensa__) || defined(__coverity_undefine___xtensa__))
#define __xtensa__ 1
#endif
